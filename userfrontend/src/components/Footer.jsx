...
const Footer = () => {
  return (
    <footer id="contact" style={{ backgroundColor: '#54413C', color: '#FFD58E' }}>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-2">
              <span className="inline-flex h-9 w-9 items-center justify-center rounded-xl" style={{ backgroundColor: '#FFD58E', color: '#54413C' }}>
            ...
            <p className="mt-4" style={{ color: 'white' }}>Modern veterinary care with a gentle touch.</p>
          </div>

          <div>
            <div className="text-sm font-semibold" style={{ color: '#FFD58E' }}>Quick Links</div>
            <ul className="mt-3 space-y-2" style={{ color: 'white' }}>
              <li><a href="#home" className="hover:text-amber-100">Home</a></li>
              <li><a href="#about" className="hover:text-amber-100">About Us</a></li>
              <li><a href="#services" className="hover:text-amber-100">Services</a></li>
              <li><a href="#faq" className="hover:text-amber-100">FAQ</a></li>
            </ul>
          </div>

          <div>
            <div className="text-sm font-semibold" style={{ color: '#FFD58E' }}>Contact</div>
            <ul className="mt-3 space-y-2" style={{ color: 'white' }}>
          ...
          <div>
            <div className="text-sm font-semibold" style={{ color: '#FFD58E' }}>Follow Us</div>
            <div className="mt-3 flex items-center gap-3">
              <a href="#" aria-label="Facebook" className="inline-flex h-9 w-9 items-center justify-center rounded-full" style={{ backgroundColor: '#54413C', color: 'white' }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
              ...
              <a href="#" aria-label="Twitter" className="inline-flex h-9 w-9 items-center justify-center rounded-full" style={{ backgroundColor: '#54413C', color: 'white' }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
              ...
              <a href="#" aria-label="Instagram" className="inline-flex h-9 w-9 items-center justify-center rounded-full" style={{ backgroundColor: '#54413C', color: 'white' }}>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5">
        ...
        <div className="mt-10 border-t pt-6 text-sm" style={{ borderColor: 'rgba(255, 255, 255, 0.2)', color: 'rgba(255, 255, 255, 0.8)' }}>
